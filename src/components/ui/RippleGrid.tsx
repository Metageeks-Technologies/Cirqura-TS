...
type UniformValue = number | number[] | [number, number] | [number, number, number] | boolean;
...
void main() {
  ...
  return <Box ref={containerRef} w="full" h="full" position="relative" overflow="hidden" css={{ '& canvas': { display: 'block' } }} />;
};
